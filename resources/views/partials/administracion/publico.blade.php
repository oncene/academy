...
<h5>Gestion de datos publicos</h5>
<table class="table table-striped table-bordered table-hover dt-responsive nowrap" id="show_datatable_publico" style="width:100%">
    <thead>
    <tr>
        <th>Name</th>
        <th>Position</th>
...
<script>
    ...
    /*********************** datatables ********************/
    var listar_table_publico = function () {
        $('#show_datatable_publico').DataTable({
            destroy: true,
            responsive: true,
            processing: true,
            // deferRender: true,
