...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/plugins/bootstrap/css/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/plugins/font-awesome/css/font-awesome.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/plugins/jquery-ui/jquery-ui.min.css') }}">
...
<body>
  ...
  <script src="{{ asset('vendor/laravel-filemanager/plugins/jquery/jquery-1.12.4.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/plugins/bootbox/bootbox.min.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
